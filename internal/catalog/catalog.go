...
var profiles = []Profile{
	...
	{ID: "gpt-5.6-sol", DisplayName: "GPT 5.6 Sol", Provider: "openai", DefaultEffort: "xhigh", AllowedEfforts: []string{"medium", "high", "xhigh"}, Strengths: []string{"complex-implementation", "architecture"}, AutoRoute: true, ProbeStatus: "tool-pass"},
